# Generated by Django 3.2 on 2022-09-17 14:29
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('img', models.ImageField(blank=True, default='default.png', null=True, upload_to=sns.models.upload_path)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('img', models.ImageField(blank=True, default='default.png', null=True, upload_to=sns.models.upload_path_group)),
        ...
        migrations.AddField(
            model_name='group',
            name='room',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='talk_room_group', to='sns.talkroom'),
        ),
        migrations.CreateModel(
            name='FriendMessage',
            fields=[
                ...
                ('receiver', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='message_receiver_friend', to=settings.AUTH_USER_MODEL)),
                ('room', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='talk_room_friend_message', to='sns.talkroom')),
            ],
            options={
                'ordering': ('-pub_date',),
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('room', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='talk_room_friend', to='sns.talkroom')),
            ],
        ),
    ]
